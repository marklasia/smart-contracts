...
contract AccessToken is BurnableToken, Ownable {
  ...
  function changeFountainLocation(address _address) onlyAllowed public {
    fountainAddress = _address;
  }

  function mint(address _to, uint256 _amount) onlyAllowed public returns (bool) {
